...
function createConnection() {
  ...
  if (user === '' || room === '') {
    alert('Coloca el username y room porfavor!');
    return false;//terminamos la funcion
  }
...
function sendMessage(message) {
  socket.emit('message', message);//<------------------------------------ENVIAMOS EL VIDEO
}
...
function handleUserMedia(stream) {//<---------------------------MOSTRAMOS EL VIDEO
